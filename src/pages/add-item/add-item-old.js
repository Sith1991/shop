...
import { AddPropertyToProductOld } from '../../components/add-property-to-product/add-property-to-product-old-version';
...
export default withRouter(AddItemOld);
